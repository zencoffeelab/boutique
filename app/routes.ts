...
export default [
  ...
  route("blog", "routes/advice.tsx"),
  route("blog/:slug", "routes/advice-detail.tsx"),
  route("conseils", "routes/legacy-advice-redirect.ts", { id: "legacy-advice-fr" }),
  route("conseils/:slug", "routes/legacy-advice-redirect.ts", { id: "legacy-advice-detail-fr" }),
  route("a-propos", "routes/about.tsx"),
  route("professionnel", "routes/professional.tsx"),
  route("professionnel/devis", "routes/professional-redirect.ts", { id: "legacy-professional-quote-fr" }),
  ...
  route("mon-compte/commandes/:id", "routes/account-order.tsx"),
  route("mon-compte/messagerie/:messageId/pieces-jointes/:attachmentId", "routes/account-mail-attachment.ts"),
  ...
  route("admin/professionnels/:id", "routes/admin-professional-detail.tsx"),
  ...
  route("admin/modifications", "routes/admin-changelog.tsx"),
  ...
  route("en/tips", "routes/legacy-advice-redirect.ts", { id: "legacy-advice-en" }),
  route("en/tips/:slug", "routes/legacy-advice-redirect.ts", { id: "legacy-advice-detail-en" }),
  route("en/blog", "routes/advice.tsx", { id: "advice-en-blog" }),
  route("en/blog/:slug", "routes/advice-detail.tsx", { id: "advice-detail-en-blog" }),
  route("en/about-us", "routes/about.tsx", { id: "about-en" }),
  route("en/professional", "routes/professional.tsx", { id: "professional-en" }),
  route("en/professional/quote", "routes/professional-redirect.ts", { id: "legacy-professional-quote-en" }),
  ...
  route("en/search", "routes/search.tsx", { id: "search-en" }),
  ...
  route("en/my-account/orders/:id", "routes/account-order.tsx", { id: "account-order-en" }),
  route("en/my-account/messaging/:messageId/attachments/:attachmentId", "routes/account-mail-attachment.ts", { id: "account-mail-attachment-en" }),
  ...
  route("api/address-suggestions", "routes/api.address-suggestions.ts"),
  ...
  route("media/storage/*", "routes/media-storage.ts"),
