    ...
    <dialog className="admin-help-dialog" id="shipping-help" ref={dialogRef} aria-labelledby="shipping-help-title" onClick={(event) => { if (event.target === event.currentTarget) event.currentTarget.close(); }}>
      <div className="admin-help-dialog__panel">
        ...
        <div className="admin-help-dialog__content">
          ...
          <section><h3>Calcul des tarifs transporteur</h3><ol><li>Le poids des paquets est additionné.</li><li>La commande est répartie dans les emballages actifs.</li><li>La tare et les dimensions de chaque colis sont ajoutées.</li><li>En France, Colissimo est demandé exclusivement à Shippo ; les autres services sont demandés à Sendcloud.</li><li>Les offres Colissimo renvoyées par Sendcloud pour la France sont toujours exclues.</li><li>Pour plusieurs colis, les tarifs du même service sont additionnés.</li></ol><p>Le devis est valable 15 minutes.</p></section>
...
export default function AdminShipping() {
  ...
  return <AdminShell active="shipping">
    <header className="admin-heading"><div><p className="eyebrow">Shippo · Sendcloud</p><div className="admin-title-with-help"><h1>Emballages & franco</h1><ShippingHelp presets={presets} thresholds={thresholds} /></div></div></header>
