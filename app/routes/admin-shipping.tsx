...
export default function AdminShipping() {
  ...
  return <AdminShell active="shipping">
    <header className="admin-heading"><div><p className="eyebrow">Shippo · Colissimo</p><div className="admin-title-with-help"><h1>Emballages & franco</h1><ShippingHelp presets={presets} thresholds={thresholds} /></div></div></header>
