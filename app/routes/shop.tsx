...
export default function Shop() {
  ...
  return <>
    <header className="page-hero page-hero--listing"><p className="eyebrow">Zen Coffee Lab</p><h1>{english ? "The coffee shop" : "La boutique café"}</h1><p className="lede">{english ? <>Bright, traceable coffees roasted to order.<br />Choose your origin,<br />then your format.</> : "Des cafés lumineux et traçables, torréfiés à la demande. Choisissez votre origine, puis votre format."}</p></header>
