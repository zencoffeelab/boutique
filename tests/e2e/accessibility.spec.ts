...
for (const path of ["/", "/boutique", "/boutique/ethiopie-aricha-station", "/professionnel", "/admin", "/admin/produits", "/admin/commandes", "/admin/expedition", "/admin/contenus", "/admin/faq", "/admin/conseils"]) {
